    ...
    public sealed class DomainEnquiryMapper : IMapper
    {
        ...
        public MySqlParameter[] CreateParameters(object entity)
        {
            ...
            parameters.AddRange(new MySqlParameter[]
            {
                ...
                new MySqlParameter("pStatus", MySqlDbType.Int32) { Value = domainEnquiry.RegistrantID, Direction = ParameterDirection.Input },
                ...
                new MySqlParameter("pStatus", MySqlDbType.VarChar, 255) { Value = domainEnquiry.Description, Direction = ParameterDirection.Input },
